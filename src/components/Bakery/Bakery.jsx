        ...
        <>
            ...
            <div className='py-5 mx-6'>
                <div className='flex gap-5 '>
                    <GiBread className='bg-[#E5E7EB] text-[#185C32] p-3 text-6xl rounded-full ' />
                    <h2 className='font-poppins font-extrabold text-[30px] text-[#185C32] '>Bakery</h2>
                </div>
                <p className=' py-3 font-poppins font-medium text-[18px] text-[#796E5F] '>
                    From oven to doorstep — enjoy warm, fresh, and fluffy baked goodness every day.
                </p>
